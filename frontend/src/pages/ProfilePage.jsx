...
import { ArrowLeft, User, Mic, Star, Calendar, Edit2, Save, X, TrendingUp, Activity, Clock, Eye, Download, FileText, ChevronLeft, ChevronRight } from 'lucide-react';
                                    ...
                                    <div className="hidden sm:flex sm:flex-1 sm:items-center sm:justify-between">
                                        <div>
                                            <p className="text-sm text-gray-700">
                                                Showing <span className="font-medium">{(currentPage - 1) * pageSize + 1}</span> to <span className="font-medium">{Math.min(currentPage * pageSize, attempts.length)}</span> of <span className="font-medium">{attempts.length}</span> results
                                            </p>
                                        </div>
                                        <div>
