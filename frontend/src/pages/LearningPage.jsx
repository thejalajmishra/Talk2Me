...
import { ArrowLeft, BookOpen, Video, Headphones, Star, Play, Clock, ArrowRight, TrendingUp } from 'lucide-react';
                    ...
                    <div className="flex flex-col lg:flex-row items-center justify-between gap-12">
                        <div className="flex-1 text-center lg:text-left">
                            ...
                            <div className="flex flex-col sm:flex-row items-center gap-4 justify-center lg:justify-start">
                                <button className="w-full sm:w-auto bg-transparent border border-white/30 text-white px-8 py-4 rounded-full font-bold hover:bg-white/10 transition-all backdrop-blur-sm">
                                    Read Guides
                                </button>
                            </div>
                        </div>
                        ...
                        <div className="flex-1 relative w-full max-w-lg lg:max-w-xl">
                            <div className="relative z-10">
                                {/* Main Mic Circle - Changed to Book/Play icon for learning */}
                                <div className="w-48 h-48 mx-auto bg-white/10 backdrop-blur-md rounded-full flex items-center justify-center border border-white/20 shadow-2xl relative">
                                    <div className="w-32 h-32 bg-gradient-to-tr from-indigo-500 to-purple-500 rounded-full flex items-center justify-center shadow-inner">
                                        <div className="w-24 h-24 bg-white rounded-full flex items-center justify-center shadow-lg">
                                            <div className="w-12 h-16 rounded-lg flex items-center justify-center relative">
                                ...
                                {/* Achievement Card -> New Course */}
                                <div className="absolute top-10 -left-4 bg-white/10 backdrop-blur-md border border-white/20 p-4 rounded-2xl shadow-xl flex items-center gap-3 animate-bounce-slow" style={{ animationDuration: '3s' }}>
                                ...
                                {/* Progress Card -> Top Rated */}
                                <div className="absolute bottom-0 -right-4 bg-white/10 backdrop-blur-md border border-white/20 p-4 rounded-2xl shadow-xl flex items-center gap-3 animate-bounce-slow" style={{ animationDuration: '4s' }}>
